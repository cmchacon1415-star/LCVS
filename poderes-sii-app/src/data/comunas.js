export const COMUNAS_POR_REGION = {
  ...
  'Metropolitana de Santiago': [
    ...
    'Vitacura', 'Puente Alto', 'Pirque', 'San José de Maipo', 'Colina', 'Lampa', 'Til Til',
...
export const COMUNAS = Object.entries(COMUNAS_POR_REGION).flatMap(([region, comunas]) =>
  comunas.map((comuna) => ({ comuna, region }))
);
